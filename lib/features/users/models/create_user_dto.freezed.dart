...
class _$CreateUserDtoImpl implements _CreateUserDto {
  const _$CreateUserDtoImpl({required this.name, required this.phone});
  ...
  @override
  String toString() {
    return 'CreateUserDto(name: $name, phone: $phone)';
  }
...
abstract class _CreateUserDto implements CreateUserDto {
  const factory _CreateUserDto(
      ...
      required final String phone}) = _$CreateUserDtoImpl;
