...
class _$UpdateUserDtoImpl implements _UpdateUserDto {
  const _$UpdateUserDtoImpl({this.name, this.phone});
  ...
  @override
  String toString() {
    return 'UpdateUserDto(name: $name, phone: $phone)';
  }
...
abstract class _UpdateUserDto implements UpdateUserDto {
  const factory _UpdateUserDto({final String? name, final String? phone}) =
      _$UpdateUserDtoImpl;
